...
The table provides the information required to interpret the criterion-checking and compatibility analyses reported in this thesis. The complete machine-readable criterion definitions, prompts, and rule-engine configuration are retained in the versioned project repository associated with this thesis.
