...
LingxiDiagBench nominally contains 16,000 synthetic psychiatric dialogues~\citep{xu2026lingxidiagbench}; because the official 1,000-case test split was unavailable at freeze, the accessible corpus for this project comprises 15,000 case IDs. This thesis assigns that accessible pool two on-disk roles, with the development role further subdivided for probe design (\Cref{tab:data-roles-rewrite}):
...
\midrule
Train-derived development pool & 13,000 lines / 12,997 unique IDs & retrieval support and development analyses & not headline evaluation\\
Public validation split & 1,000 (drawn from the pool above) & configuration and probe design & not a test set\\
