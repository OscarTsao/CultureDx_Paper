...
Distribution shift is a third boundary. The external MDD-5k analysis preserves the same stage-wise questions, but its compatibility inclusion and profile rates differ from the internal trace and vary across archived MDD-5k lineages. The TF--IDF transfer matrix shows strong within-corpus performance but limited and asymmetric transfer across the two synthetic corpora. This finding does not by itself establish superior transfer by HiED. Together, these results support a synthetic cross-corpus boundary analysis, not real-patient or cross-hospital generalization.
