...
\newcommand{\LaneLabel}[1]{{\bfseries\fontsize{11.7}{12.8}\selectfont #1}}
...
\node[text=laneBlue, anchor=west] at (0.18,3.88) {\LaneLabel{DIAGNOSIS}};
\node[text=laneBlue, anchor=west] at (0.18,3.43) {\LaneLabel{PATH}};
\node[text=laneBlue, anchor=west] at (0.18,-3.47) {\LaneLabel{CRITERION-}};
\node[text=laneBlue, anchor=west] at (0.18,-3.92) {\LaneLabel{CHECKING PATH}};
...
\node[outputbox, minimum width=2.55cm] (retrieved) at (8.26,2.90)
{\OutputTitle{Retrieved}\\[-1pt]\OutputTitle{Similar Cases}};
...
{\ModuleTitle{Criterion Checker}\\[-1pt]\ModuleTitle{Agents}};
...
\node[finalout, minimum width=3.25cm] (finalprimary) at (19.90,0.10)
{\OutputTitle{Committed Primary}\\[-1pt]\OutputSub{Diagnosis}};
