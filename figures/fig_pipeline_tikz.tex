...
% The three .tex files keep their existing \includegraphics{fig_pipeline.pdf} unchanged.
...
\node[ragbox] (rag) at (3.3,0)   {Retrieval (RAG)\\[-1pt]{\scriptsize 1 case / disorder}};
\node[agent] (dx)  at (6.6,0)   {Diagnostician\\[-1pt]{\scriptsize 5 candidates}};
\node[dec]  (pri) at (11.4,0)  {Committed primary\\[-1pt]{\scriptsize + comorbid}};

% ---- Row 2: audit branch ----
\node[agent] (chk)   at (3.3,-2.4)  {Criterion checkers\\[-1pt]{\scriptsize Per-disorder ICD-10}};
\node[logic] (logic) at (6.6,-2.4)  {Logic engine\\[-1pt]{\scriptsize Count thresholds}};
